...
% \thispagestyle{empty}
% \vspace{-3em}
I am a Ph.D. student in the Computer Science Department at the University of Toronto.  During my graduate study, I contributed to both the machine learning and sports analytics communities.  My projects were published in the NeurIPS, ICML, ICLR, AISTATS, ICASSP and Sloan Sports Analytics Conference (SSAC).   
...
\section{Aligning with research at Google}
Research from Google has certainly played an influential role in my own research, including publications in the area of OOD detection, few-shot learning, graph neural networks to name a few. 

I believe that my research interest and the research agenda outlined above align well with research at Google. 
