...
% \thispagestyle{empty}
% \vspace{-3em}
In this cover letter I include a short research statement, highlight some of my personal quality, and describe how my work is relevant to the Sugiyama Lab.  Thank you for considering my application.
...
My research vision is to achieve an agent that can \textbf{\textit{recognize distribution-shift, and quickly adapt to it.}}

There are a couple of immediate problems with the current OOD detection methods. 
...
\textbf{Relevance to the Sugiyama Lab:}
I understand that one of the long term visions of the Sugiyama lab is to achieve robust machine learning, i.e. learning with noisy, and incomplete information.  I believe that my experience and interest are complementary to the lab.  I have published projects about various deep generative models, which are useful tools for reasoning about density in high-dimensional spaces. Both recently and in the past the Sugiyama lab and Professor Sugiyama had use the technique of density-ratio, and importance weighing in the application of learning under covariate shift and anomaly detection~\citep{abe2019anomaly,sugiyama2007direct,sugiyama2008direct}.  I believe that advancing deep generative model specifically to improve this line of work will be one mutual interest.  Recently the Sugiyama lab has also contributed to the topic of few-shot learning~\citep{teshima2020few}, which can be seen as another type of learning  under distribution shift. On top of deep generative models and anomaly detection, I spent a significant portion of my Ph.D. on the topic of few-shot learning~\citep{wang2019centroid,wang2019customizable,wang2020fsood}.  I believe my experience on this topic can accelerate the effort on few-shot learning in the Sugiyama lab.
...
Throughout my Ph.D., I have contributed to a 5-year IARPA funded project, ~\href{https://www.iarpa.gov/index.php/research-programs/microns}{MICrONS} where I worked with not only machine learning researchers, but also neuro-scientists to combine neuroscience with the latest progress in AI. Personally, I see great values in mentorship.  When I was a junior student, I was very fortunate to have learned from senior students and postdocs.  I'm very excited about the possibility of sharing my experiences and technical knowledge with students who are getting started with AI research.
